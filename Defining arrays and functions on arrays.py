class Array_Seq:
    def __init__(self): # O(1)
        self.A = [] #creates an empty list or a tuple like structure
        self.size = 0 # size of tuple

    def __len__(self): return self.size # O(1)
    def __iter__(self): yield from self.A # O(n) iter_seq (used within a generator to delegate all of its operations to another generator or iterable)
